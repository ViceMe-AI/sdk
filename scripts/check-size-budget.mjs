...
const BUDGETS = {
  ...
  // Includes Access v3 PKCE recovery, identity lifecycle, and first-party navigation fallback.
  'viceme.min.js': { gzip: 16 * 1024, label: 'CDN loader with shared Website access client' },
